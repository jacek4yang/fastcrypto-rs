        .globl fastcrypto_curve25519_x25519base
        .type fastcrypto_curve25519_x25519base, %function
        .hidden fastcrypto_curve25519_x25519base
        .globl fastcrypto_curve25519_x25519base_byte
        .type fastcrypto_curve25519_x25519base_byte, %function
        .hidden fastcrypto_curve25519_x25519base_byte
        .text
        .balign 32
fastcrypto_curve25519_x25519base:
fastcrypto_curve25519_x25519base_byte:
        .cfi_startproc
        ...
        movq (%rsp), %rax
        andq $8, %rax
        leaq fastcrypto_curve25519_x25519base_constant(%rip), %r10
        leaq 8*12(%r10), %r11
        movq (%r10), %rax
        movq (%r11), %rcx
        cmovnzq %rcx, %rax
...
Lcurve25519_x25519base_midloop:
        ...
        retq ; .cfi_endproc
.size fastcrypto_curve25519_x25519base, .-fastcrypto_curve25519_x25519base
.section .note.GNU-stack, "", %progbits
.section .rodata
.type fastcrypto_curve25519_x25519base_constant, %object
.size fastcrypto_curve25519_x25519base_constant, 48576
fastcrypto_curve25519_x25519base_constant:
