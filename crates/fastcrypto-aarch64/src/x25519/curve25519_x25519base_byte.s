...
fastcrypto_curve25519_x25519base_byte:
        ...
        ldr x0, [sp, #(0*32)]
        ands xzr, x0, #8
        adrp x19, fastcrypto_curve25519_x25519base_byte_constant
        add x19, x19, :lo12:fastcrypto_curve25519_x25519base_byte_constant
        ldp x0, x1, [x19]
        ldp x2, x3, [x19, #96]
        csel x0, x0, x2, eq
        csel x1, x1, x3, eq
...
Lcurve25519_x25519base_byte_invmidloop:
        ...
        ret ; .cfi_endproc
.size fastcrypto_curve25519_x25519base_byte, .-fastcrypto_curve25519_x25519base_byte
.section .note.GNU-stack, "", %progbits
.section .rodata
.type fastcrypto_curve25519_x25519base_byte_constant, %object
.size fastcrypto_curve25519_x25519base_byte_constant, 48576
fastcrypto_curve25519_x25519base_byte_constant:
