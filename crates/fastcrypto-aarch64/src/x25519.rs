...
global_asm!(include_str!("x25519/curve25519_x25519_byte.s"));
global_asm!(include_str!("x25519/curve25519_x25519_byte_alt.s"));
global_asm!(include_str!("x25519/curve25519_x25519base_byte.s"));
global_asm!(include_str!("x25519/curve25519_x25519base_byte_alt.s"));
...
pub fn x25519_standard(out: &mut [u8; 32], scalar: &[u8; 32], point: &[u8; 32]) {
...
pub fn x25519_wide_multiplier(out: &mut [u8; 32], scalar: &[u8; 32], point: &[u8; 32]) {
    // SAFETY: pointer contract as in `x25519`; runs on every ARMv8 CPU.
    unsafe {
...
///
/// Testing and benchmarking only.
pub fn x25519_base_standard(out: &mut [u8; 32], scalar: &[u8; 32]) {
...
///
/// Testing and benchmarking only.
pub fn x25519_base_wide_multiplier(out: &mut [u8; 32], scalar: &[u8; 32]) {
    // SAFETY: pointer contract as in `x25519_base`; runs on every ARMv8 CPU.
...
mod tests {
    ...
    /// preprocessor conditional is pinned on the command line.
    #[test]
